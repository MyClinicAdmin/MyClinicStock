...
class _EnviarEmailPageState extends State<EnviarEmailPage> {
  ...
  void initState() {
    super.initState();
    // Lê produtos do Firestore e agrupa por fornecedor (itens abaixo do mínimo)
    _future = EmailService.carregarGrupos();
  }
                            ...
                            children: [
                              ...
                              FilledButton.icon(
                                ...
                                onPressed: () async {
                                  ...
                                  if (to.isEmpty) return _err('Indica um destinatário padrão.');
                                  final subject = 'Pedido de reposição — Itens em falta';
                                  final body = EmailService.textoConsolidado(grupos);
                                  ...
                                  children: [
                                    ...
                                    FilledButton.icon(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (to.isEmpty) return _err('Sem e-mail do fornecedor e sem fallback.');
